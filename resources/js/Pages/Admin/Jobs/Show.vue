    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <!-- {{-- Action Links --}} -->
                <div
                    class="inline-flex mb-12 overflow-hidden rounded-md shadow-sm"
                >
                    <a
                        ...
                        target="_blank"
                        :href="route('frontend.job_details', job.data.id)"
                    >
                        View
                    </a>
                ...
                >
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <article>
                            <h2
                                class="pb-5 text-xl font-semibold leading-6 text-gray-800 dark:text-gray-50"
                            >
                                Description
                            </h2>
                            <p
                                class="leading-8 text-gray-600 dark:text-gray-300"
                            >

        ...
        <main>
            <header class="relative pt-8 overflow-hidden isolate">
                ...
                <div class="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    >
                        <Link
                            class="mb-8 flex flex-row items-center justify-center gap-2 rounded-lg border border-gray-600 bg-gray-50/10 px-4 py-2.5 text-sm font-medium text-gray-200 transition hover:bg-gray-800/30 hover:text-blue-700 hover:text-white focus:z-10 focus:outline-none"
            ...
            <div class="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div class="lg:col-start-3 lg:row-end-1">
                        ...
                        <div
                            class="p-6 rounded-lg shadow-sm outline-none bg-white/5 ring-1 ring-inset ring-gray-900/5 ring-white/10"
                        >
                            ...
                            <a
                                class="block w-full px-5 py-3 font-semibold text-center transition bg-indigo-500 rounded-lg text-gray-50 hover:bg-indigo-400 hover:duration-500"
                    ...
                    <!-- Job Description -->
                    <div
                        class="px-4 py-8 bg-gray-600 rounded-lg shadow-sm outline-none bg-white/5 text-gray-50 ring-1 ring-inset ring-gray-900/5 ring-white/10 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16"
                    >
                        <h2
